 ...
 */
Ext.eu.sm.datePickerButton = Ext.extend(Ext.Button, {
	displayFormat		: 'd/m/Y',
	date				: (new Date()),
	initComponent		: function(){
		...
		Ext.eu.sm.datePickerButton.superclass.initComponent.call(this);
	}
});

Ext.reg('datepickerbutton',Ext.eu.sm.datePickerButton);
